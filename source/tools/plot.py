...
def plot_model_params(
    ...
    if isinstance(sId, LSSM) and not isinstance(sId, SSM):
        sId_BRAID = MainModel.MainModel()
        sId_BRAID.setToLSSM(sId, model1_Cy_Full=False, model2_Cz_Full=False)
        sId = sId_BRAID
    if isinstance(sId, MainModel.MainModel):
